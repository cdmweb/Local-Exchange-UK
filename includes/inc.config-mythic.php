...
//CT stuff for browser navigation and sourcing
define ("SERVER_DOMAIN", "https://dev.camlets.org.uk"); // no trailing slash
define ("SERVER_PATH_URL", "/members"); // no trailing slash
define ("HTTP_BASE", SERVER_DOMAIN .SERVER_PATH_URL); // put it all together
define ("IMAGES_PATH",  HTTP_BASE . "/images/");
define ("STYLES_PATH",  HTTP_BASE . "/styles/");
define ("UPLOADS_PATH",  HTTP_BASE . "/uploads/");

// CT backend sourcing
//DELETE once project not using pear
define ("PEAR_PATH",  "/Applications/MAMP/PEAR"); // no trailing slash
define ("DOCUMENT_BASE", $_SERVER["DOCUMENT_ROOT"] . SERVER_PATH_URL);
define ("CLASSES_PATH",  DOCUMENT_BASE ."/classes/");

define ("INCLUDES_PATH",  DOCUMENT_BASE . "/includes/");
define ("TEMPLATES_PATH",  DOCUMENT_BASE . "/includes/templates/");
...
define("AGE_ARRAY", array('18-30','30\'s','40\'s','50\'s','60\'s','70\'s','Over 80','I would rather not say'));

// The options available in the 'What Sex are you?' dropdown. At the time of writing (01-12-2008) the defaults should be fine
// key is just the number key...
define("SEX_ARRAY", array("Male","Female","I would rather not say"));

define("MEMBER_ROLE_ARRAY", array("Member", "Committee", "Administrator"));
