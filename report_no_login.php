<?php
	...
	$p->page_title = "Members Who Have Never Logged In";
	...
	$table = new cTable;
	$table->AddSimpleHeader(array("Member", "Join Date", "Phone Number(s)", "Email(s)"));
	...
	if($output == "")
		$output = "All members in the system have logged in at least once.";
