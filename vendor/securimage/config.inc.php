...
return array(
    ...
    'database_host'    => 'localhost:3306',     // database server host to connect to
    'database_user'    => 'clarat2_leuser',          // database user to connect as
    'database_pass'    => '05dbI?uWkWBy',              // database user password
    'database_name'    => 'clarat2_camlets2',    // name of database to select (you must create this first or use an existing database)
